...
const PlaylistInfo: React.FC<PlaylistInfoProps> = ({ playlist }) => {
  return (
    <div className="flex flex-row items-center justify-start rounded-xl lg:flex-col h-full lg:h-screen w-screen sm:w-full md:w-full lg:w-1/2 xl:w-1/3 2xl:w-1/3 bg-slate-800 bg-opacity-80">
      <Link
        className="w-full"
      ...
      >
        <div className="group relative flex flex-col items-center justify-center w-full">
          <img
            className="h-40  lg:h-48 w-4/5 px-5 rounded-sm my-3 group-hover:opacity-20"
